...
class Trainer(object):
    ...
    def init_meters(self, args):
        ...
        self.meters['sent_loss'] = AverageMeter()
        self.meters['doc_loss'] = AverageMeter()
    ...
    def train_step(self, samples, dummy_batch=False, raise_oom=False):
        ...
        try:
            ...
            sent_loss = logging_output.get('sent_loss', 0)
            doc_loss = logging_output.get('doc_loss', 0)
            self.meters['sent_loss'].update(sent_loss)
            self.meters['doc_loss'].update(doc_loss)
