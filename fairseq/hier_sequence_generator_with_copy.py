...
class HierSequenceGenerator_with_copy(object):
    def __init__(
        self,
        tgt_dict,
        beam_size=1,
    ...
    def generate(
        ...
        **kwargs
        ...
        # separately, but SequenceGenerator_with_copy directly calls model.encoder
        encoder_input = {
            k: v for k, v in sample['net_input'].items()
            if k != 'prev_output_tokens'
        }

        src_tokens = sample['src_tokens_for_infer']
