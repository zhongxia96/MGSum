...
def get_train_and_test_parser(default_task='translation'):
    parser = get_parser('Trainer', default_task)
...
def add_preprocess_args(parser):
    ...
    group.add_argument("-e", "--edge-lang", default='edge', metavar="TARGET",
                       help="target language")
    group.add_argument("-m", "--mask-lang", default='mask', metavar="TARGET",
                       help="target language")
    group.add_argument("-p", "--position-lang", default='position', metavar="TARGET",
                       help="target language")
    group.add_argument("-sent", "--sent-lang", default='sent', metavar="TARGET",
                       help="target language")
    group.add_argument("-d", "--doc-lang", default='doc', metavar="TARGET",
                       help="target language")
    ...
    group.add_argument("--edgedict", metavar="FP",
                       help="reuse given edgedict dictionary")
