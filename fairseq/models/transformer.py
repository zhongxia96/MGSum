...
@register_model_architecture('transformer', 'transformer_iwslt_de_en_test')
def transformer_iwslt_de_en_test(args):
...
@register_model_architecture('transformer', 'transformer_medium')
def transformer_gigaword(args):
    args.encoder_embed_dim = getattr(args, 'encoder_embed_dim', 512)
    args.encoder_ffn_embed_dim = getattr(args, 'encoder_ffn_embed_dim', 2048)
    args.encoder_attention_heads = getattr(args, 'encoder_attention_heads', 8)
    args.encoder_layers = getattr(args, 'encoder_layers', 6)
...
@register_model_architecture('transformer', 'transformer_LDC15')
def transformer_gigaword(args):
...
@register_model_architecture('transformer', 'transformer_LDC15_big')
def transformer_gigaword(args):
    args.encoder_embed_dim = getattr(args, 'encoder_embed_dim', 512)
    args.encoder_ffn_embed_dim = getattr(args, 'encoder_ffn_embed_dim', 2048)
    args.encoder_attention_heads = getattr(args, 'encoder_attention_heads', 8)
...
@register_model_architecture('transformer', 'transformer_iwslt_en_de')
def transformer_iwslt_en_de(args):
    args.encoder_embed_dim = getattr(args, 'encoder_embed_dim', 512)
    args.encoder_ffn_embed_dim = getattr(args, 'encoder_ffn_embed_dim', 1024)
    args.encoder_attention_heads = getattr(args, 'encoder_attention_heads', 4)
    args.encoder_layers = getattr(args, 'encoder_layers', 6)
...
@register_model_architecture('transformer', 'transformer_gigaword_big')
